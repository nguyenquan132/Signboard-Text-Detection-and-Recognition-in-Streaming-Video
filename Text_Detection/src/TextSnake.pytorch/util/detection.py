...
class TextDetector(object):
    ...
    def find_innerpoint(self, cont):
        ...
        :return:
        """
        # Sometime, I encounterd wrong like: "- Can't parse 'pt'. Sequence item with index 0 has a wrong type" with
        # cv2.pointPolygonTest(cont, (xmean, i), False). So, I added a code line versus Author
        cont = cont.astype(np.float32) # added by me
        xmean = cont[:, 0, 0].mean()
