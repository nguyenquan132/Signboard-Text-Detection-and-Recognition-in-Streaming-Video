...
\section{Các phương pháp tiếp cận}
...
\subsection{Phát hiện và nhận dạng văn bản ngoại cảnh (Scene Text Detection and Recogntion - STDR)}
\subsubsection{Phát hiện văn bản ngoại cảnh (Scene Text Detection - STD)}
\subsubsubsection{Cơ sở và hướng tiếp cận chung}
...
\subsubsubsection{Các nghiên cứu liên quan}
...
\subsubsection{Nhận dạng văn bản (Scene Text Recognition - STR)}
\subsubsubsection{Cơ sở và hướng tiếp cận chung}
...
\end{itemize}
\subsubsection{Nhận dạng văn bản ngoại cảnh đầu–cuối (End-to-End Scene Text Recognition)}
\subsubsubsection{Cơ sở và hướng tiếp cận chung}
