...
\begin{itemize}
    ...
    \item \textbf{Thực nghiệm và đánh giá:} Tiến hành cài đặt, thực nghiệm và phân tích kết quả cho các tác vụ phát hiện biển hiệu, phát hiện văn bản và nhận dạng văn bản, qua đó làm rõ ưu và nhược điểm của các phương pháp trong bối cảnh dữ liệu đường phố Việt Nam, đồng thời cung cấp cơ sở tham khảo cho các nghiên cứu và ứng dụng trong tương lai.
    \item \textbf{Xây dựng quy trình xử lý đầu-cuối (pipeline end-to-end):} Xây dựng quy trình xử lý đầu-cuối hoàn chỉnh cho bài toán phát hiện và nhận dạng văn bản trên biển hiệu trong video hành trình tại Việt Nam.
\end{itemize}
...
\item \textbf{Ứng dụng thực tế:} Phát triển giao diện người dùng cho ứng dụng phát hiện và nhận dạng văn bản trên biển hiệu trong video đường phố Việt Nam, hỗ trợ phân tích nội dung biển hiệu, tra cứu địa điểm và thông tin cửa hàng, qua đó phục vụ các hệ thống tìm kiếm và phân tích loại hình kinh doanh.
\end{itemize}
